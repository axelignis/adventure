...
import { Mountain, Mail, Loader2, AlertTriangle } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@/components/ui/card";

// Check if providers are available (client-side check)
const hasResend = typeof window !== 'undefined' && process.env.NEXT_PUBLIC_HAS_RESEND === 'true';
const hasGoogle = typeof window !== 'undefined' && process.env.NEXT_PUBLIC_HAS_GOOGLE === 'true';
